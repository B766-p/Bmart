<%-- 
    Document   : viewodersS
    Created on : 20-Apr-2024, 18:57:41
    Author     : DELL
--%>
  ...
  <div id="content" style="display: none;">
    ...
    <div class="container">
      <% try {
        ...
        PreparedStatement ps = connection.prepareStatement("SELECT * FROM orders1 WHERE semail = ?");
        ps.setString(1, uid);
        ...
        <div class="card-details">
          ...
          <% } else { %>
            <a href="assingd.jsp?oi=<%=  resultSet.getString("ORDERID")  %>"><button class="shop-now-btn">Assing delivery boy</button></a>
             <a href="updateprushop.jsp?oi=<%=  resultSet.getString("ORDERID")  %>"><button class="shop-now-btn">edit</button></a>
